...
export const CardHeader: React.FC<{ item?: ServiceItem; isCTA: boolean }> = ({ item, isCTA }) => (
...
export const CardBody: React.FC<{ 
  ...
  isCTA: boolean;
  subtextClass: string;
}> = ({ title, description, language, isCTA, subtextClass }) => (
...
export const CardFooter: React.FC<{ 
  ...
  btnText?: string; 
  lineClass: string;
}> = ({ isCTA, language, btnText, lineClass }) => (
  <>
